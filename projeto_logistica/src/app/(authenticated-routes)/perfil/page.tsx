            ...
            <div className="w-full bg-white-simple shadow-md shadow-black-gray-border rounded-md">
                <div className="flex items-stretch">
                    <div className='w-[30%] 2xl:w-[30%]'>
                        <div className="shadow-md shadow-black-gray-border bg-[url('/assets/green-blur.png')] p-5 flex h-full justify-center place-items-center rounded-l-md">
                    ...
                    <div className="flex flex-col w-full self-end px-10 pb-10">
                        ...
                        <div className="mt-8">
                            ...
                            <p className="shadow-sm shadow-black-gray-border w-full p-3 text-black outline-0 bg-transparent border rounded-md border-green-simple/80 text-md font-medium">amandacruz@pormade.com.br</p>
                        </div>
