                ...
                <div className="w-full">
                    <div className="mb-12 w-full">
                                ...
                                <div className="w-full flex justify-center text-center  pt-10 pb-5">
                                    <LiaFileInvoiceDollarSolid className="hidden sm:flex fill-green-simple sm:h-6 sm:w-6 md:h-8 md:w-8 xl:w-9 xl:h-9 mx-2"/>
                                    <p className="font-medium text-xl md:text-2xl xl:text-3xl capitalize">Generalidades {transportadora && transportadora.nome}</p>
                                </div>
