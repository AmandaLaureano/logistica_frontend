...
export default function Line({ field, valueField, minValueField, onChangeValue, onChangeValueMin }: ILinesTaxForms) {
    return (
        <div className="w-full border-b-[1px] border-slate-200 h-12">
            <div className="flex hover:bg-green-simple/20 transition-all duration-500 w-full h-full text-base my-auto">
