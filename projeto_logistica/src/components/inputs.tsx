...
export function InputFile({ placeholder, onClick, onChange, accept, text }: IInputFile) {
    return (
        <div className={`bg-green-simple p-2 px-6 rounded md text-2xl text-white w-72 text-center`}>
            ...
            <label className='text-left text-placeholder w-full h-full whitespace-nowrap overflow-hidden cursor-pointer sm:pl-2 py-2 flex' htmlFor='InputFile'>
